...
from nsdk.biometrics import IrisesEngine, NBiometricOperations
...
def main(args):
    ...
    irisdata, tempplates = engine.detect_iris(nimage, operation=NBiometricOperations.create_template)
    tempplates[0].to_buffer().to_file(args.template_name)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Enroll iris from image')
